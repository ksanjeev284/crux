...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=192"><img src="assets/ledger-light.svg?v=192" width="100%" alt="CRUX ledger, height 192"></picture>

| | |
|---|---|
| **height** | `192` |
| **tip** | `000020c6860315beb4d2bceadccac49b48f4716f4061548ae255c0be6fb89c22` |
| **difficulty** | `95,870.5`  (bits `0x1f00aeff`) |
| **chainwork** | `7,485,871` expected hashes |
| **supply** | `9650.00000000 CRUX` in `193` unspent outputs |
| **next reward** | `50.00000000 CRUX` |
| **next retarget** | in `15` block(s) |
| **next halving** | in `209807` block(s) |
| **transactions** | `193` |
...
| `184` | `0000b635db7fb81c0c5c…` | [@americanvain](https://github.com/americanvain) | &nbsp; | `1` | `50.00000000` | 2026-09-12 03:11 UTC |
| `183` | `00006847a6ef4d35a58b…` | [@americanvain](https://github.com/americanvain) | &nbsp; | `1` | `50.00000000` | 2026-09-12 02:48 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@americanvain](https://github.com/americanvain) | `192` | `99.5%` |
...
|---|---|--:|
| [@americanvain](https://github.com/americanvain) | `crux1qfhk8zkgy4axu0skh40kaxyctljm6s9qpqdkxwh` | `9600.00000000 CRUX` |
