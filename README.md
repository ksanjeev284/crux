...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=96"><img src="assets/ledger-light.svg?v=96" width="100%" alt="CRUX ledger, height 96"></picture>

| | |
|---|---|
| **height** | `96` |
| **tip** | `0002562983b423587daf6bca5dd217c82841c9ce37f61c4b712a5a65ab5bea0a` |
| **difficulty** | `16,383.8`  (bits `0x1f040000`) |
| **chainwork** | `104,607` expected hashes |
| **supply** | `4850.00000000 CRUX` in `97` unspent outputs |
| **next reward** | `50.00000000 CRUX` |
| **next retarget** | in `15` block(s) |
| **next halving** | in `209903` block(s) |
| **transactions** | `97` |
...
| `87` | `000f98e2b3afbb60aa99…` | [@americanvain](https://github.com/americanvain) | &nbsp; | `1` | `50.00000000` | 2026-09-11 05:23 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@americanvain](https://github.com/americanvain) | `96` | `99.0%` |
...
|---|---|--:|
| [@americanvain](https://github.com/americanvain) | `crux1qfhk8zkgy4axu0skh40kaxyctljm6s9qpqdkxwh` | `4800.00000000 CRUX` |
