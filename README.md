...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=155"><img src="assets/ledger-light.svg?v=155" width="100%" alt="CRUX ledger, height 155"></picture>

| | |
|---|---|
| **height** | `155` |
| **tip** | `000059724bcbd57fc841aad765cad08ca0cfcd04469e702b18059b95e09a229f` |
| **difficulty** | `34,736.0`  (bits `0x1f01e2fc`) |
| **chainwork** | `4,038,864` expected hashes |
| **supply** | `7800.00000000 CRUX` in `156` unspent outputs |
| **next reward** | `50.00000000 CRUX` |
| **next retarget** | in `4` block(s) |
| **next halving** | in `209844` block(s) |
| **transactions** | `156` |
...
| miner | blocks | share |
|---|--:|--:|
| [@americanvain](https://github.com/americanvain) | `155` | `99.4%` |
...
|---|---|--:|
| [@americanvain](https://github.com/americanvain) | `crux1qfhk8zkgy4axu0skh40kaxyctljm6s9qpqdkxwh` | `7750.00000000 CRUX` |
