...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=138"><img src="assets/ledger-light.svg?v=138" width="100%" alt="CRUX ledger, height 138"></picture>

| | |
|---|---|
| **height** | `138` |
| **tip** | `000053ca6098638cc378679de6e0839c218bc0985616c82371fffa09b0c5fa3c` |
| **difficulty** | `138,943.5`  (bits `0x1e78bf25`) |
| **chainwork** | `2,927,307` expected hashes |
| **supply** | `6950.00000000 CRUX` in `139` unspent outputs |
| **next reward** | `50.00000000 CRUX` |
| **next retarget** | in `5` block(s) |
| **next halving** | in `209861` block(s) |
| **transactions** | `139` |
...
| miner | blocks | share |
|---|--:|--:|
| [@americanvain](https://github.com/americanvain) | `138` | `99.3%` |
...
|---|---|--:|
| [@americanvain](https://github.com/americanvain) | `crux1qfhk8zkgy4axu0skh40kaxyctljm6s9qpqdkxwh` | `6900.00000000 CRUX` |
