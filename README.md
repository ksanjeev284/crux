...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=92"><img src="assets/ledger-light.svg?v=92" width="100%" alt="CRUX ledger, height 92"></picture>

| | |
|---|---|
| **height** | `92` |
| **tip** | `0006c4d9762dc023bb090f0b6c1503e283e31ac51cc4260502910b22e2b211a7` |
| **difficulty** | `4,095.9`  (bits `0x1f100000`) |
| **chainwork** | `75,939` expected hashes |
| **supply** | `4650.00000000 CRUX` in `93` unspent outputs |
| **next reward** | `50.00000000 CRUX` |
| **next retarget** | in `3` block(s) |
| **next halving** | in `209907` block(s) |
| **transactions** | `93` |
...
| miner | blocks | share |
|---|--:|--:|
| [@americanvain](https://github.com/americanvain) | `92` | `98.9%` |
...
|---|---|--:|
| [@americanvain](https://github.com/americanvain) | `crux1qfhk8zkgy4axu0skh40kaxyctljm6s9qpqdkxwh` | `4600.00000000 CRUX` |
