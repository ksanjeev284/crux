...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=162"><img src="assets/ledger-light.svg?v=162" width="100%" alt="CRUX ledger, height 162"></picture>

| | |
|---|---|
| **height** | `162` |
| **tip** | `000080db832c4e42858345bf04e05f668881f8a4c0df652142eb3b08393fe476` |
| **difficulty** | `117,833.2`  (bits `0x1f008e61`) |
| **chainwork** | `4,531,310` expected hashes |
| **supply** | `8150.00000000 CRUX` in `163` unspent outputs |
| **next reward** | `50.00000000 CRUX` |
| **next retarget** | in `13` block(s) |
| **next halving** | in `209837` block(s) |
| **transactions** | `163` |
...
| miner | blocks | share |
|---|--:|--:|
| [@americanvain](https://github.com/americanvain) | `162` | `99.4%` |
...
|---|---|--:|
| [@americanvain](https://github.com/americanvain) | `crux1qfhk8zkgy4axu0skh40kaxyctljm6s9qpqdkxwh` | `8100.00000000 CRUX` |
