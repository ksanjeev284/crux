...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=189"><img src="assets/ledger-light.svg?v=189" width="100%" alt="CRUX ledger, height 189"></picture>

| | |
|---|---|
| **height** | `189` |
| **tip** | `000017979145a1ce5ded600c80c77d61c304606460f50bd5a5a6de1b1502fbf4` |
| **difficulty** | `82,927.6`  (bits `0x1f00ca4f`) |
| **chainwork** | `7,224,144` expected hashes |
| **supply** | `9500.00000000 CRUX` in `190` unspent outputs |
| **next reward** | `50.00000000 CRUX` |
| **next retarget** | in `2` block(s) |
| **next halving** | in `209810` block(s) |
| **transactions** | `190` |
...
| `181` | `00002c72f5c787c4d27f…` | [@americanvain](https://github.com/americanvain) | &nbsp; | `1` | `50.00000000` | 2026-09-12 02:37 UTC |
| `180` | `0000b643ab2d53e4db94…` | [@americanvain](https://github.com/americanvain) | &nbsp; | `1` | `50.00000000` | 2026-09-12 02:35 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@americanvain](https://github.com/americanvain) | `189` | `99.5%` |
...
|---|---|--:|
| [@americanvain](https://github.com/americanvain) | `crux1qfhk8zkgy4axu0skh40kaxyctljm6s9qpqdkxwh` | `9450.00000000 CRUX` |
