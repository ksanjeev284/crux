...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=168"><img src="assets/ledger-light.svg?v=168" width="100%" alt="CRUX ledger, height 168"></picture>

| | |
|---|---|
| **height** | `168` |
| **tip** | `00005458488a9361cb7bda36288b8b2528c41c3f755e4c2905510290ab29947f` |
| **difficulty** | `117,833.2`  (bits `0x1f008e61`) |
| **chainwork** | `5,238,314` expected hashes |
| **supply** | `8450.00000000 CRUX` in `169` unspent outputs |
| **next reward** | `50.00000000 CRUX` |
| **next retarget** | in `7` block(s) |
| **next halving** | in `209831` block(s) |
| **transactions** | `169` |
...
| miner | blocks | share |
|---|--:|--:|
| [@americanvain](https://github.com/americanvain) | `168` | `99.4%` |
...
|---|---|--:|
| [@americanvain](https://github.com/americanvain) | `crux1qfhk8zkgy4axu0skh40kaxyctljm6s9qpqdkxwh` | `8400.00000000 CRUX` |
