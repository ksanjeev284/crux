...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=137"><img src="assets/ledger-light.svg?v=137" width="100%" alt="CRUX ledger, height 137"></picture>

| | |
|---|---|
| **height** | `137` |
| **tip** | `000077bc7f0333e07adab5b3e701baf9560fe9a3ba7a1c1e430043e968d3ae14` |
| **difficulty** | `138,943.5`  (bits `0x1e78bf25`) |
| **chainwork** | `2,788,362` expected hashes |
| **supply** | `6900.00000000 CRUX` in `138` unspent outputs |
| **next reward** | `50.00000000 CRUX` |
| **next retarget** | in `6` block(s) |
| **next halving** | in `209862` block(s) |
| **transactions** | `138` |
...
| miner | blocks | share |
|---|--:|--:|
| [@americanvain](https://github.com/americanvain) | `137` | `99.3%` |
...
|---|---|--:|
| [@americanvain](https://github.com/americanvain) | `crux1qfhk8zkgy4axu0skh40kaxyctljm6s9qpqdkxwh` | `6850.00000000 CRUX` |
