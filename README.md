...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=154"><img src="assets/ledger-light.svg?v=154" width="100%" alt="CRUX ledger, height 154"></picture>

| | |
|---|---|
| **height** | `154` |
| **tip** | `0000c5a71b634525a03b44cf0dc37737a4d2a3c869264e22f52b6cc543c334bd` |
| **difficulty** | `34,736.0`  (bits `0x1f01e2fc`) |
| **chainwork** | `4,004,128` expected hashes |
| **supply** | `7750.00000000 CRUX` in `155` unspent outputs |
| **next reward** | `50.00000000 CRUX` |
| **next retarget** | in `5` block(s) |
| **next halving** | in `209845` block(s) |
| **transactions** | `155` |
...
| miner | blocks | share |
|---|--:|--:|
| [@americanvain](https://github.com/americanvain) | `154` | `99.4%` |
...
|---|---|--:|
| [@americanvain](https://github.com/americanvain) | `crux1qfhk8zkgy4axu0skh40kaxyctljm6s9qpqdkxwh` | `7700.00000000 CRUX` |
